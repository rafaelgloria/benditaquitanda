...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { categorizacao_id: @produto.categorizacao_id, descricao: @produto.descricao, nome: @produto.nome, unidade_id: @produto.unidade_id, valorunitario: @produto.valorunitario }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { categorizacao_id: @produto.categorizacao_id, descricao: @produto.descricao, nome: @produto.nome, unidade_id: @produto.unidade_id, valorunitario: @produto.valorunitario }
    assert_redirected_to produto_path(assigns(:produto))
  end
